...
from account.serializer import RegisterSerializer, ForgotPasswordCompleteSerializer, ForgotPasswordSerializer
...
class ForgotPasswordCompleteAPIView(APIView):
    def post(self, request):
        ...
        return Response(f'{User} пароль успешно изменен')